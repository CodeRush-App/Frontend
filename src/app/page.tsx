    ...
    <Box sx={{ display: "flex", flexDirection: "column" }}>
      <Box sx={{ display: "flex", position: "relative", height: "60vh", width: "100%", alignItems: "center", minHeight: "400px" }}>
        ...
        <Box sx={{ display: "flex", pl: "20vw", flexFlow: "column", position: "absolute", width: "50vw", gap: 2 }}>
          <Box color="textPrimary" sx={{ fontSize: 36, fontWeight: "bold", textAlign: "start", }} >
            Lorem ipsum dolor sit amet, consetetur sadipscing
          </Box>
          <Box color="textPrimary" sx={{ fontSize: 20, textAlign: "start" }} >
            Lorem ipsum dolor sit amet, consetetur sadipscing elitr, tempor invidunt ut labore et dolore magna aliquyam erat
          </Box>
          <Box sx={{ display: "flex", gap: 2, alignItems: "center" }}>
            <Button variant="contained" color="primary" href="/loginSelection">Get Started </Button>
          </Box>
        </Box>
      </Box>

      <Box color="textPrimary" sx={{ fontSize: 36, fontWeight: "bold", textAlign: "start", mt: 8, alignSelf: "center" }}> What we offer</Box>
      ...
      <Box sx={{ display: "flex", pr: "10vw", pl: "10vw", pt: 10, pb: 10, justifyContent: "space-between", alignItems: "center" }}>
        <Box sx={{ display: "flex", flexDirection: "column", gap: 2, mt: 4, width: "25vw" }}>
          <Box color="textPrimary" sx={{ fontSize: 32, fontWeight: "bold" }}>
            Coding Battles
          </Box>
        ...
        <Paper sx={{ flex: 1 }}>
          <MagicCard gradientColor="#27375E">
            <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100%", p: 2 }}>
              ...
              <Button variant="contained" color="secondary" sx={{ mt: 4, mb: 10 }} href="/userRegister">
                Get started now
              </Button>
            </Box>
          </MagicCard>
        ...
        <Paper sx={{ flex: 1 }}>
          <MagicCard gradientColor="#27375E">
            <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100%", p: 2 }}>
              ...
              <Button variant="contained" color="secondary" sx={{ mt: 4, mb: 10 }} href="/companyRegister">
                Request Access
              </Button>
            </Box>
          </MagicCard>
